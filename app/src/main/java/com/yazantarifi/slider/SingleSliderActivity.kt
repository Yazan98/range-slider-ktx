...
class SingleSliderActivity : AppCompatActivity() {

    private lateinit var binding: ActivitySingleSliderBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivitySingleSliderBinding.inflate(layoutInflater)
