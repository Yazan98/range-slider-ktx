...
import com.yazantarifi.slider.databinding.ActivitySingleSingleBinding
import com.yazantarifi.slider.databinding.ActivitySingleSliderBinding

class SingleSingleActivity : AppCompatActivity() {

    private lateinit var binding: ActivitySingleSingleBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivitySingleSingleBinding.inflate(layoutInflater)
